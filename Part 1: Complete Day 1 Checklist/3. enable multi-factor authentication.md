...
**Step 5**: To set up the device, copy the secret key by clicking **Show secret key**. Paste it on the app to start receiving codes. Copy two of the consecutive received codes in fields **MFA code 1** and **MFA code 2**. Click **Add MFA**.
