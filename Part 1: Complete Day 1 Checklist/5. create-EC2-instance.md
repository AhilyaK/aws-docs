...
You are done! You can now see the instance in the **Instances** list as shown below. Wait a few minutes until the **Running** status is reached to start using the instance.
</br></br>
